...
The original S&P 500 launched on 1957-03-04 with **500 constituents** 
(425 industrials + 60 utilities + 15 railroads). However, BOTH public 
sources above only document **205 adds** on launch day (1957-03-03/04).
The missing 295 names (59%) were published only in the 
"Standard & Poor's Security Price Index Record, 1957 edition" (91 industry 
subgroups), which is not freely digitized. Requires WRDS/COMPUSTAT/CRSP.

Impact:
- sp500_changes_merged.parquet: accurate for DOCUMENTED changes only
- sp500_membership.parquet: INCOMPLETE before 1964 (only 205/500 on 1957-03-04)
- First documented change after launch: 1964 (per tickerleague)
...
def main():
    ...
    # CRITICAL WARNING: Membership panel is incomplete before 1964
    print("������ WARNING: Membership panel before 1964 is INCOMPLETE")
    print("   - Original 1957-03-04 launch: 500 constituents (425 ind + 60 util + 15 rail)")
    print("   - Documented in public sources: 205 tickers only (59% gap)")
    print("   - First documented change after launch: 1964 (per tickerleague)")
    print("   - See docstring for full caveat")
